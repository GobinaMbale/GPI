...
export class TypeMaterielComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.typeMaterielService
      ...
      .subscribe(
        (res: HttpResponse<ITypeMateriel[]>) => {
  ...
  trackId(index: number, item: ITypeMateriel): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITypeMateriel[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/type-materiel'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
