...
describe('Component Tests', () => {
  describe('UserMgr Management Component', () => {
    let comp: UserMgrComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserMgrComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userMgrs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
