...
describe('Component Tests', () => {
  describe('Enseigner Management Component', () => {
    let comp: EnseignerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EnseignerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.enseigners?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
