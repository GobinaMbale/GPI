...
describe('Component Tests', () => {
  describe('ReserverSalle Management Component', () => {
    let comp: ReserverSalleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReserverSalleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.reserverSalles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
