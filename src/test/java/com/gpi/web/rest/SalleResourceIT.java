...
class SalleResourceIT {
    ...
    private static final String DEFAULT_CAMPUS = "AAAAAAAAAA";
    private static final String UPDATED_CAMPUS = "BBBBBBBBBB";
    ...
    void createSalle() throws Exception {
        ...
        assertThat(testSalle.getCampus()).isEqualTo(DEFAULT_CAMPUS);
    ...
    void getAllSalles() throws Exception {
        ...
        restSalleMockMvc
            ...
            .andExpect(jsonPath("$.[*].campus").value(hasItem(DEFAULT_CAMPUS)))
    ...
    void getSalle() throws Exception {
        ...
        restSalleMockMvc
            ...
            .andExpect(jsonPath("$.campus").value(DEFAULT_CAMPUS))
    ...
    void putNewSalle() throws Exception {
        ...
        updatedSalle.code(UPDATED_CODE).nom(UPDATED_NOM).campus(UPDATED_CAMPUS).capacite(UPDATED_CAPACITE).batiment(UPDATED_BATIMENT);
        ...
        assertThat(testSalle.getCampus()).isEqualTo(UPDATED_CAMPUS);
    ...
    void partialUpdateSalleWithPatch() throws Exception {
        ...
        partialUpdatedSalle.capacite(UPDATED_CAPACITE);
