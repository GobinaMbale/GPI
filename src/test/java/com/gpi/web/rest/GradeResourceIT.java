...
class GradeResourceIT {
    ...
    public static Grade createEntity(EntityManager em) {
        Grade grade = new Grade().code(DEFAULT_CODE).intitule(DEFAULT_INTITULE).description(DEFAULT_DESCRIPTION);
        return grade;
    }
    ...
    public static Grade createUpdatedEntity(EntityManager em) {
        Grade grade = new Grade().code(UPDATED_CODE).intitule(UPDATED_INTITULE).description(UPDATED_DESCRIPTION);
        return grade;
    }
    ...
    void createGrade() throws Exception {
        ...
        assertThat(testGrade.getIntitule()).isEqualTo(DEFAULT_INTITULE);
    ...
    void putNewGrade() throws Exception {
        ...
        updatedGrade.code(UPDATED_CODE).intitule(UPDATED_INTITULE).description(UPDATED_DESCRIPTION);
        ...
        assertThat(testGrade.getIntitule()).isEqualTo(UPDATED_INTITULE);
    ...
    void partialUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.code(UPDATED_CODE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.code(UPDATED_CODE).intitule(UPDATED_INTITULE).description(UPDATED_DESCRIPTION);
